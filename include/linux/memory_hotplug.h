...
extern void vmemmap_substract_pages(unsigned long pfn, unsigned long nr_pages);
extern void vmemmap_account_pages(unsigned long pfn, unsigned long nr_pages);
