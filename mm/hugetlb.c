...
retry_avoidcopy:
	 ...
	 * the reserve for this address was consumed.
	 * If reserves were used, a partial faulted mapping at the fime of
	 * fork() could consume its reserves on COW instead of the full address
	 * range.
	 */
